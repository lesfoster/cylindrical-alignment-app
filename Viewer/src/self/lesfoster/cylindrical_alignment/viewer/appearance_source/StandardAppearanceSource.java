...
public class StandardAppearanceSource implements AppearanceSource {
    ...
    /**
     * Tells if this entity is to have its color affected by its scoring
     * position or not.
     *
     * @param entityType
     ...
     *
     * @param lightenColor true if wish to apply a slightly lighter shade to the
     * color.
     */
     ...
     * @return color object with r,g,b as its colors. Or null if parse
     * impossible.
     */
